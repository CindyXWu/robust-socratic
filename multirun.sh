...
experiment_s="exhaustive_0,exhaustive_1,exhaustive_3,exhaustive_4,exhaustive_5,exhaustive_6"
args="config_type=EXHAUSTIVE distill_loss_type=BASE dataset.box_cue_pattern=MANDELBROT log_teacher=False"
