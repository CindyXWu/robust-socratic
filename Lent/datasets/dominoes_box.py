...
class domCueDataset(Dataset):
    """Dominoes with large box cues.
    
    These are not the pixel single-color boxes used for the CIFAR10 box dataset. They are larger patches of randomised pixels.
    
    Futue TODO: add option to use various patterns for 'spurious cues'.
    """
    def __init__(self, 
                 dataset: Union[CIFAR10, CIFAR100], 
