...
# For shapes exhaustive experiments (never used)
...
# For dominoes exhaustive experiments
...
# Used for renaming to make sure things are in the correct order when plotting from wandb
